...
\midrule
Novel calc.\ (SciTaT, 18) & ``The difference is 1.09'' (correct: 4.5\%) & Paper paragraph + data table. Must read both and compute $11.6\%{-}7.1\%{=}4.5\%$. Model has zero training knowledge. & Endorses --- no basis to resist (0.80) & Stays uncertain --- no one can argue & No \\
\bottomrule
\end{tabular}
\end{center}
\end{table}
